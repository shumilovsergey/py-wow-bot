...
L["Always shows the aura, highlight it if buffed."] = "Всегда показывает ауру, выделит ее, если показана"
L["Always shows the aura, grey if buff not active."] = "Всегда показывает ауру, серую, если бафф не активен."
L["Amount"] = "Количество"
...
L["Basic Show On Cooldown"] = "Основное отображение когда восстановливается"
L["Only shows the aura when the ability is on cooldown."] = "Показывает ауру только тогда, когда способность находится на перезарядке."
L["Basic Show On Ready"] = "Основное отображение когда готово"
L["Only shows the aura when the ability is ready to use."] = "Показывает ауру только тогда, когда способность готова к использованию."
L["Charge Tracking"] = "Отслеживание заряда"
L["Always shows the aura, turns blue on insufficient resources."] = "Всегда показывает ауру, становится синей на недостаточных ресурсах."
L["Charge and Duration Tracking"] = "Отслеживание заряда и продолжительности"
L["Tracks the charge and the duration of spell, highlight while the spell is active, blue on insufficient resources."] = "Отслеживает заряд и продолжительность заклинания, выделяет как заклинание активно, синее на недостаточных ресурсах."
L["Charge and Buff Tracking"] = "Заряд и отслеживание баффа"
L["Tracks the charge and the buff, highlight while the buff is active, blue on insufficient resources."] = "Отслеживает заряд и бафф, выделяйте, пока бафф активен, синий на недостаточных ресурсах."
L["Charge and Debuff Tracking"] = "Заряд и отслеживание дебаффа"
...
L["Show On"] = "Показать"
L["Show Only if Buffed"] = "Показать только если найдено"
L["Only shows the aura if the target has the buff."] =  "Показывает ауру только в том случае, если у цели есть бафф."
L["Show Only if Debuffed"] = "Показан только в том случае, если есть дебафф"
L["Only show the aura if the target has the debuff."] = "Показывает ауру только в том случае, если у цели есть дебафф."
L["Always show the aura, highlight it if debuffed."] = "Всегда показывает ауру, выделит ее, если дебаффнут"
L["Always show the aura, turns grey if the debuff not active."] = "Всегда показывает ауру, станет серой, если дебафф не активен."
L["Show Only if on Cooldown"] = "Показывает только в перезарядке"
L["Only show the aura when the item is on cooldown."] = "Покажет ауру только тогда, когда предмет находится на восстановлении."
L["Show on Ready"] = "Показывает когда готово"
L["Only shows the aura when the ability is ready to use."] = "Показывает ауру только тогда, когда способность готова к использованию."
L["Always show the aura, turns grey if on cooldown."] = "Всегда показывает ауру, становится серым, если на перезарядке."
L["Show Only if Enchanted"] = "Покажет только если зачаровано"
